        ...
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
            ...
            <%@include file="./include/header.jsp" %>
                ...
                <body>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${loginUser.user_id eq vo.userId && vo.seatType=='N'}">
                                                ...
                                                <div class="box myseat" data-id="${vo.seatId}"
                                                    ...
                                                    data-reserv="${vo.reservationId}" data-index="${status.index}"
                                                    style="top:${vo.y}px; left: ${vo.x}px;">${vo.seatName}</div>
                                            </c:when>
                                            <c:otherwise>

                                                <div class="box" data-id="${vo.seatId}" data-type="${vo.seatType}"
                                                    data-name="${vo.seatName }" data-index="${status.index}"
                                                    style="top:${vo.y}px; left: ${vo.x}px;">${vo.seatName}</div>
                    ...
                    <div class="modal fade mdoal-del" id="exampleModal" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">좌석 수정 창</h5>
                                    <button type="button" class="close del-close" data-dismiss="modal"
                                        aria-label="Close">
