							...
							<c:forEach var="vo" items="${seat }">
								...
								<c:choose>
									...
									<c:when test="${loginUser.user_id eq vo.userId && vo.seatType=='N'}">
										...
										<div class="box myseat" data-id="${vo.seatId}" data-type="${vo.seatType}"
											data-name="${vo.seatName }" data-reserv="${vo.reservationId}" onclick="checkOut(this)">${vo.seatName}</div>
									</c:when>
									<c:otherwise>

										<div class="box" data-id="${vo.seatId}" data-type="${vo.seatType}"
											data-name="${vo.seatName }" onclick="addConfirm(this)">${vo.seatName}</div>
