			...
			<head>
				...
				<style>
					...
					.rate>label:before {
						...
						height: 26px;
						cursor: pointer;
						content: url("https://static.oliveyoung.co.kr/pc-static-root/image//product/bg_rating_star.png");
					}
								...
								<c:choose>
									<c:when test="${reservationVO != null}">
										<li class="reviewView"> <!-- 리뷰 작성 (이용한 지점이 있으면 뜨도록) -->
											<form id="frm1" action="reviewInsert.do" method="post"
												...
												<div class="text-area-store"> <!-- 지점이름 -->
													...
													<input type="hidden" name="store_id"
														value="${reservationVO.storeId}">
													<input type="hidden" name="store_name"
														value="${reservationVO.storeName}">
													<input type="hidden" name="reservation_id"
														value="${reservationVO.reservationId}">
												...
												<div class="text-area-zone"> <!-- 작성하는 text box -->
													<textarea name="review_content" class="tazone"
													...
													<ul class="inner">
														<li>
															<a href="#">
																<span>
																	<!-- 이미지 경로 수정해야함################################## -->
																	<img src="${pageContext.request.contextPath}/resources/img/${reviewList.review_filename}"
																		style="width: 165px;">
																</span>
															</a>
														</li>
